...
if raster_layer is None or not isinstance(raster_layer, QgsRasterLayer):
    ...
    output_filename = f"{raster_name_without_ext}_vulnerabilidade_Tmin.tif"
    ...
    try:
        ...
        if result and 'OUTPUT' in result:
            output_layer = QgsRasterLayer(output_path, f"{raster_name_without_ext}_vulnerabilidade_Tmin")
